...
class MathController extends GetxController {
  var messages = <ChatGeometry>[
    ChatGeometry(role: 'bot', part: 'Hello, How can i help you today?')
  ].obs;
  final scroll = ScrollController();

  late Box<ChatGeometry> chatBox = Hive.box<ChatGeometry>('chat_geometry');

  void loadMessages() {
    messages.addAll(chatBox.values);
  }

  void addMessage(ChatGeometry message) {
