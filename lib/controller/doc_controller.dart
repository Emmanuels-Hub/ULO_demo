...
class DocController extends GetxController {
  var messages = <ChatDoc>[ChatDoc(role: 'bot', part: 'Hello, How can i help you today?')].obs;
  final scroll = ScrollController();

  late Box<ChatDoc> chatBox = Hive.box<ChatDoc>('chat_doc');

  void loadMessages() {
    messages.addAll(chatBox.values);
  }

  void addMessage(ChatDoc message) {
