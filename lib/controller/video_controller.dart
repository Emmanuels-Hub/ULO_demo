...
class VideoController extends GetxController {
  var messages = <ChatVideo>[
    ChatVideo(role: 'bot', part: 'Hello, How can i help you today?')
  ].obs;
  final scroll = ScrollController();

  late Box<ChatVideo> chatBox = Hive.box<ChatVideo>('chat_video');

  void loadMessages() {
    messages.addAll(chatBox.values);
  }

  void addMessage(ChatVideo message) {
